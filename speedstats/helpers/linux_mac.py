# (c) https://gist.github.com/pklaus/289646#gistcomment-2396272
import array
import fcntl
import socket
import struct
...
def get_local_interfaces():
    ...
    # NOTE: mutated_byte_buffer is just a reference to mutable_byte_buffer -
    # for the sake of clarity we've defined them as
    # separate variables, however they are the same address space -
    # that's how fcntl.ioctl() works since the mutate_flag=True
    # by default.
